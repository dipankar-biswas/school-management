            ...
            <tr>
                ...
                <td>
                  <a class="btn btn-sm btn-primary" onclick="modalShowUpdate({{$data->id}})" href=""><i class="fa fa-edit"></i></a>
                    ...
                    <a onclick="return confirm('Are you sure Delete?')" href="{{Route('sdelete.delete', 'id='.$data->id)}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
      ...
      <div class="modal-body">
        ...
        <form id="myForm" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <small class="form-text" id="errimage">Image size 960x300 and less than 1 MB.</small>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="myFormUpdate" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <small class="form-text" id="erruimage">Image size 960x300 and less than 1 MB.</small>
          </div>
