    ...
    <div class="m-2 my-4">
      ...
      <div class="card-body">
          ...
          <div style="overflow: hidden;">
            <h3 class="float-left">Wedget list</h3>
        ...
        <tbody>
          @foreach($widget as $data)
            <tr>
                ...
                <td>{{$data->priority}}</td>
                <td>
                  <img src="{{asset($data->image)}}" height="40px" width="40px">
                </td>
                <td>
                  @if($data->status == 1)
                ...
                <td>
                  <a class="btn btn-sm btn-primary" href="" onclick="modalShowUpdate({{$data->id}})"><i class="fa fa-edit"></i></a>
                    <a onclick="return confirm('Are you sure Delete?')" href="{{Route('wedelete.delete', 'id='.$data->id)}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
          @endforeach
        </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add wedget</h5>
      ...
      <div class="modal-body">
        ...
        <form id="myForm" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <small class="form-text" id="errimage">* Image size must be less than 1 MB.</small>
          </div>
          <div class="form-group">
...
<div class="modal fade" id="exampleModalUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update Wedget</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ...
        <form id="myFormUpdate" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <small class="form-text" id="erruimage">Image must be less than 1 MB..</small>
          </div>
          <div class="form-group">
